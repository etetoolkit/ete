...
sys.path.append(os.path.abspath('/home/jhuerta/_Devel/ete/ete21-beta/'))
print sys.path
...
copyright = u'2010, Jaime Huerta-Cepas'
...
htmlhelp_basename = 'EnvironmentforTreeExplorationdoc'
