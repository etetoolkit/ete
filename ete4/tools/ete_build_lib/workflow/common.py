        ...
        for wkname, wkfilter in npr_conf.npr_workflows:
            ...
            if ALG and ("min_seq_sim" in wkfilter or "max_seq_sim" in wkfilter):
                if not hasattr(_n, "seqs_mean_ident"):
                    ...
                    _n.add_props(seqs_max_ident=mx, seqs_min_ident=mn,
                ...
                _n.add_props(seqs_max_ident=None, seqs_min_ident=None,
...
def assembly_tree(runid):
    ...
    while task_nodes:
        ...
        for leaf in tree.iter_leaves():
            leaf.add_props(safename=leaf.name)
        ...
        tree.add_props(iternumber=iternumber)
        iternumber += 1
