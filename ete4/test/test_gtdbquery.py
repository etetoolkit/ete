...
class Test_gtdbquery(unittest.TestCase):
    ...
    def test_01tree_annotation(self):
        ...
        self.assertEqual(firmicutes.props.get('named_lineage'), [u'root', u'd__Bacteria', u'p__Firmicutes'])
    ...
    def test_gtdbquery(self):
        ...
        #name_lineage = gtdb.get_name_lineage(['RS_GCF_006228565.1','GB_GCA_001515945.1'])
    ...
    def test_get_topology(self):
        ...
        self.assertEqual(sorted(tree.get_leaf_names()), ['f__Korarchaeaceae', 'o__Peptococcales', 'p__Huberarchaeota'])

    def test_name_lineages(self):
        gtdb = GTDBTaxa(dbfile=DATABASE_PATH)
        out = gtdb.get_name_lineage(['RS_GCF_006228565.1'])
        self.assertEqual(out[0]['RS_GCF_006228565.1'], ['root', 'd__Bacteria', 'p__Firmicutes_B', 'c__Moorellia', 'o__Moorellales', 'f__Moorellaceae', 'g__Moorella', 's__Moorella thermoacetica', 'RS_GCF_006228565.1'])
