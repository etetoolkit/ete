...
* `ete ncbiquery <http://etetoolkit.org/documentation/ete-ncbiquery/>`_: dump descendant taxa given a taxid or taxa name. new option `--descendants`; renamed `--taxonomy` by `--tree`
