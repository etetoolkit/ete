...
Use the method :func:`NCBITaxa.update_taxonomy_database` to download
and parse the latest database from the NCBI ftp site. Your current
...
used as the taxid attribute.  Note that the :func:`PhyloNode.annotate_ncbi_taxa`:
